...
bfp_converter #(
    ...
    .input_valids         (ce_out_valids_r),
    .input_fixed_array    (ce_out_fixed_r),
    .input_base_exp_array (ce_out_base_exp_r),
    .input_zero_array     (ce_out_zero_r),

    .output_valids        (bfp_valids),
    .output_mant_array    (bfp_mants),
    .output_shared_exp    (bfp_shared_exp),   // ✅ 8bit 指数
