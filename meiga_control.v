...
//================================================================================
// Module: meiga_control v3.0 (训练模式支持版)
// Description: MEIGA系统顶层控制FSM - 支持推理和训练两种模式
//              管理Backbone和Sidenet的层级处理、Bank切换、训练控制
// 
// Author: MEIGA Design Team
// Date: 2025-11-27
// Version: 3.0 (Added training mode support)
// Standard: Verilog 2001
//
// 主要变更 (v3.0):
//   - 新增训练模式支持（STATE_TRAINING）
//   - 训练期间不启动新的forward
//   - 训练完成后返回IDLE
//   - 保持原有推理功能不变
//
...
module meiga_control #(
    ...
    output reg  train_start_pulse,  // 给DFA的训练启动脉冲（单周期）
