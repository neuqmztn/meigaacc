...
//================================================================================
// Sidenet Gate Engine (Full Precision / Non-Simplified)
//
// 严格实现流程：
// 1. Load: 读取 Z 和 A 的 BFP 向量
// 2. Gating: 执行定点乘法 (1-g)*z 和 g*a
// 3. Add: 通过流水线 BFP 加法器处理 8 个维度，暂存 8 个独立结果 (Exp_i, Mant_i)
// 4. Scan: 在计算过程中动态追踪最大指数 (Global Max Exp)
// 5. Align: 将 8 个独立结果根据 Global Max Exp 进行右移对齐
// 6. Pack: 组合最终结果并输出
//================================================================================
